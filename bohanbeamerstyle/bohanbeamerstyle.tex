...
\begin{tabular}{ccc}
\includegraphics[height=3mm]{bohanbeamerstyle/figures/mail.png} & \includegraphics[height=3mm]{bohanbeamerstyle/figures/github.png} &\includegraphics[height=3mm]{bohanbeamerstyle/figures/Twitter.png}
\end{tabular}
